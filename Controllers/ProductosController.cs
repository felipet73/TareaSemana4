...
namespace TareaSemana4.Controllers
{
    public class ProductosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Nombre,Codigo_Barras,Stock,Precio,Descripcion,Notas,Id,Create_At,Update_At,isDelete")] ProductosModel productosModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Nombre,Codigo_Barras,Stock,Precio,Descripcion,Notas,Id,Create_At,Update_At,isDelete")] ProductosModel productosModel)
        {
