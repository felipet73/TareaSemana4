...
namespace TareaSemana4.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public ClientesController(BaseDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Nombres,Email,Telefono,Direccion,Cedula_RUC,Id,Create_At,Update_At,isDelete")] ClientesModel clientesModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Nombres,Email,Telefono,Direccion,Cedula_RUC,Id,Create_At,Update_At,isDelete")] ClientesModel clientesModel)
        {
